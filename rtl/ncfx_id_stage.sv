...
(
    ...
    logic [31:0]      imm_d;
    ncfx_alu_op_t     alu_op_d;
    ncfx_branch_t     branch_type_d;
    ncfx_fwd_sel_t    fwd_rs1_sel_d;
    ncfx_fwd_sel_t    fwd_rs2_sel_d;
    ncfx_mem_size_t   mem_size_d;
    ...
    always_comb begin
        ...
        rs2_used_d = 1'b0;
        imm_d = 32'h0000_0000;
        alu_op_d = NCFX_ALU_ADD;
        branch_type_d = NCFX_BR_NONE;
        alu_src_imm_d = 1'b0;
        mem_read_d = 1'b0;
        mem_write_d = 1'b0;
        mem_size_d = NCFX_SIZE_WORD;
        ...
        if (if2_inst_i != 32'h0000_0000) begin
            case (class_d)
                4'h0: begin
                    ...
                    case (op_d)
                        4'h1: alu_op_d = NCFX_ALU_ADD;
                        4'h2: alu_op_d = NCFX_ALU_SUB;
                        4'h3: alu_op_d = NCFX_ALU_AND;
                        4'h4: alu_op_d = NCFX_ALU_OR;
                        4'h5: alu_op_d = NCFX_ALU_XOR;
                        4'h6: alu_op_d = NCFX_ALU_SLT;
                        4'h7: alu_op_d = NCFX_ALU_SLTU;
                        4'h8: alu_op_d = NCFX_ALU_SLL;
                        4'h9: alu_op_d = NCFX_ALU_SRL;
                        4'hA: alu_op_d = NCFX_ALU_SRA;
                        4'hB: alu_op_d = NCFX_ALU_MUL;
                        4'hC: alu_op_d = NCFX_ALU_MULH;
                        4'hD: alu_op_d = NCFX_ALU_MULHU;
                        4'hE: alu_op_d = NCFX_ALU_MULHSU;
                ...
                4'h1: begin
                    ...
                    case (op_d)
                        4'h0: begin
                            alu_op_d = NCFX_ALU_ADD;
                            imm_d = ncfx_sext16(imm16_d);
                        end
                        4'h1: begin
                            alu_op_d = NCFX_ALU_AND;
                            imm_d = ncfx_zext16(imm16_d);
                        end
                        4'h2: begin
                            alu_op_d = NCFX_ALU_OR;
                            imm_d = ncfx_zext16(imm16_d);
                        end
                        4'h3: begin
                            alu_op_d = NCFX_ALU_XOR;
                            imm_d = ncfx_zext16(imm16_d);
                        end
                        4'h4: begin
                            is_lui_d = 1'b1;
                ...
                4'h3: begin
                    ...
                    alu_src_imm_d = 1'b1;
                    alu_op_d = NCFX_ALU_ADD;
                    imm_d = ncfx_sext16(imm16_split_d);

                    case (op_d)
                        4'h0: mem_size_d = NCFX_SIZE_BYTE;
                        4'h1: mem_size_d = NCFX_SIZE_HALF;
                        4'h2: mem_size_d = NCFX_SIZE_WORD;
                        default: illegal_d = 1'b1;
                    endcase
                end
                ...
                4'h4: begin
                    rs1_used_d = 1'b1;
                    rs2_used_d = 1'b1;
                    imm_d = ncfx_sext16_shift2(imm16_split_d);

                    case (op_d)
                        4'h0: begin
                            branch_type_d = NCFX_BR_UNCOND;
                            rs1_used_d = 1'b0;
                            rs2_used_d = 1'b0;
                        ...
                        4'h1: branch_type_d = NCFX_BR_EQ;
                        4'h2: branch_type_d = NCFX_BR_NE;
                        4'h3: branch_type_d = NCFX_BR_LT;
                        4'h4: branch_type_d = NCFX_BR_LTU;
                        default: illegal_d = 1'b1;
                    endcase
                end
                ...
                4'h5: begin
                    ...
                    case (op_d)
                        4'h0: begin
                            is_jal_d = 1'b1;
                            imm_d = ncfx_sext20_shift2(off20_d);
                        end
                        4'h1: begin
                            is_jalr_d = 1'b1;
                            rs1_used_d = 1'b1;
    ...
    always_ff @(posedge clk) begin
        if (rst) begin
            ...
            idex_fwd_rs1_sel_o   <= NCFX_FWD_NONE;
            idex_fwd_rs2_sel_o   <= NCFX_FWD_NONE;
            idex_illegal_o       <= 1'b0;
